...
- [Part 1: data-intensive systems](./practicals/part1.md)
  - [Practical 1: Micronaut basics](./practicals/01-micronaut-basics.md)
  ...
  - [Practical 2: ORM with Micronaut Data](./practicals/02-micronaut-data.md)
  ...
  - [Practical 3: Integrating services](./practicals/03-service-integration.md)
    ...
    - [Additional exercises](./practicals/service-integration/05-additional-exercises.md)
  - [Practical 4: Reacting to events](./practicals/04-micronaut-kafka.md)
    ...
    - [Background processing](./practicals/micronaut-kafka/07-background-processing.md)
  - [Practical 5: Deploying as containers](./practicals/05-container-orchestration.md)
    ...
    - [Docker basics](./practicals/container-orchestration/03-docker.md)
    - [Writing the Compose spec](./practicals/container-orchestration/04-compose.md)
    - [Additional exercises](./practicals/container-orchestration/05-additional-exercises.md)
- [Part 2: model-driven engineering](./practicals/part2.md)
  - [Practical 6: Metamodeling and modelling](./practicals/modelling-and-metamodelling/index.md)
  ...
  - [Practical 7: Graphical syntax and editor development](./practicals/graphical-syntax-and-editor-development/index.md)
  ...
  - [Practical 8: Model querying](./practicals/model-querying/index.md)
    - [Introduction](./practicals/model-querying/introduction.md)
    - [Conference DSL queries](./practicals/model-querying/conference-dsl-queries.md)
    - [Software Distribution DSL queries](./practicals/model-querying/software-distribution-dsl-queries.md)
    - [Research Project DSL queries](./practicals/model-querying/research-project-dsl-queries.md)
  - [Practical 9: Model validation](./practicals/model-validation/index.md)
    - [Introduction](./practicals/model-validation/introduction.md)
    - [Conference DSL constraints](./practicals/model-validation/conference-dsl-constraints.md)
    - [Additional exercises](./practicals/model-validation/additional-exercises.md)
  - [Practical 10: Model transformation](./practicals/model-transformation/index.md)
  ...
  - [Practical 11: Model workflows](./practicals/model-workflows/index.md)
